...
const SVG3 = () => {
  return <g>
    ...
    <g id='process_outline'>
      ...
      ></path>
      <path
        fill='#333' d="m256.033 151.001c-24.04 0-46.641 9.362-63.64 26.361-3.905 3.905-3.905 10.237 0 14.142s10.237 3.905 14.142 0c26.055-27.156 72.94-27.155 98.994.001 1.953 1.952 4.512 2.928 7.071 2.928 8.68.154 13.409-10.92 7.071-17.071-16.997-16.999-39.598-26.361-63.638-26.361z"
      ></path>
      <path
        fill='#333' d="m284.317 222.716c8.692.152 13.402-10.922 7.071-17.071-18.611-19.395-52.1-19.396-70.711.001-9.031 9.679 4.452 23.18 14.143 14.142 5.666-5.666 13.199-8.787 21.213-8.787s15.547 3.121 21.213 8.787c1.952 1.952 4.512 2.928 7.071 2.928z"
      ></path>
      <path
        fill='#333' d="m246.029 241.001c0 5.526 4.482 10.005 10.008 10 13.25-.491 13.239-19.514-.008-20-5.523 0-10 4.477-10 10z"
      ></path>
      <path
...
const aboutData = [
  { heading: 'Pixel Perfect', bg_frame: '/images/round1.png', svg: <SVG1 />, desc: 'Most common methods for designing websites that work well on desktop is responsive and adaptive design.' },
  { heading: 'High Quality', bg_frame: '/images/round2.png', svg: <SVG2 />, desc: 'Most common methods for designing websites that work well on desktop is responsive and adaptive design.' },
  { heading: 'Awesome Idea', bg_frame: '/images/round3.png', svg: <SVG3 />, desc: 'Most common methods for designing websites that work well on desktop is responsive and adaptive design' },
...
const Section2 = () => {
  ...
  return (
    <div className=' section2_content min-h-[10vh] border-0 py-[6rem] lg:py-[8rem]  '>
      <div ref={ref} className={` container flex  flex-col gap-4 lg:gap-0 lg:flex-row justify-between ${isVisible ? 'slide-in' : 'opacity-0'}`} >
        ...
        {aboutData.map((item, index) => (
          <div key={index} className=' w-5/6 mx-auto lg:w-1/4 text-center' >
            <span className='dizme_tm_process'>
              <img
                className="brush"
                src={item?.bg_frame || "/images/round1.png"}
                alt=""
              />
              <svg
